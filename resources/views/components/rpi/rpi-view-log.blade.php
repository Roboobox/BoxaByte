<x-rpi.rpi-panel-layout>
    <x-slot name="main">
        <div class="content p-4 mb-5">
            <div class="row">
                <div class="return">
                    <a class="text-primary btn ps-0 fw-bold" href="{{ url()->previous() ?? route('rpi-bot-logs') }}"><i class="fa-solid fa-arrow-left-long"></i> Return </a>
                </div>
                <h4 class="mb-0">GjrofildBot Log #{{ $log->id }}</h4>
            </div>
            <div class="row mt-4">
                <div class="col-12">
                    <div class="mb-2">
